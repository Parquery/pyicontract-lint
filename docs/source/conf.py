...
project = pyicontract_lint_meta.__title__
copyright = pyicontract_lint_meta.__copyright__
...
release = pyicontract_lint_meta.__version__
...
htmlhelp_basename = 'pyicontract-lintdoc'
